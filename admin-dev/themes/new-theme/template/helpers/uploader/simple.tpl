...
<div class="form-group">
	<div class="col-lg-12" id="{$id|escape:'html':'UTF-8'}-images-thumbnails">
		...
		<div>
			...
			<p>
				<a class="btn btn-primary" href="{$file.delete_url}">
...
<div class="form-group">
	<div class="col-sm-8">
		...
		<div class="dummyfile input-group">
			<span class="input-group-addon"><i class="material-icons">insert_drive_file</i></span>
			<input class="form-control custom-file-input" id="{$id|escape:'html':'UTF-8'}-name" type="text" name="{$name|escape:'html':'UTF-8'}" readonly />
			<span class="input-group-btn">
				<button id="{$id|escape:'html':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-primary">
					<i class="material-icons">folder</i> {if isset($multiple) && $multiple}{l s='Add files'}{else}{l s='Add file'}{/if}
				</button>
				{if (!isset($multiple) || !$multiple) && isset($files) && $files|count == 1 && isset($files[0].download_url)}
					<a href="{$files[0].download_url|escape:'html':'UTF-8'}" class="btn btn-primary">
